...
import { useOAuthSignIn, useSignUp } from '../../src/features/auth/hooks';
...
export default function SignUp() {
  ...
  const showCheckInbox = signUp.isSuccess && !signUp.data?.session;
      ...
      >
        ...
        >
          <Button
            ...
            onPress={() => {
              events.authCreateAccountTapped('sign_up');
